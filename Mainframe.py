...
class admin_use:
    def __init__(self):
        ...
        self.mycursor.execute("USE phone_specifications")

    # Function to display all data
    def display_data(self):
        self.mycursor.execute("SELECT * FROM specifications")
...
class Admin(admin_use):
    def caller(self):
        admin_use.display_data(self) #display_data function called
        while True:
            print("1. ADD PHONE")
            ...
            if choice == "1":
                admin_use.add_data(self)
                #add_data function called
            elif choice == "2":
                admin_use.delete_data(self) #delete_data function called
            elif choice == "3":
                admin_use.modify_data(self) #modify_data function called
            elif choice == "4":
                break #loop exited
            else:
                print("Invalid choice. Please enter a number between 1 and 4.")

        admin_use.display_data(self)
